...
tags: ['java', 'guide']
draft: false
summary: 'Java is a powerful programming language known for being object-oriented. As a result, it is easy to create data types, or classes, that are instantiated as objects.'
authors: ['jadentang']
---
